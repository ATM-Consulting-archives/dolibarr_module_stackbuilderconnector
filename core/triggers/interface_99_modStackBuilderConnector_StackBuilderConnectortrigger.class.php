...
/**
 * 	\file		core/triggers/interface_99_modMyodule_StackBuilderConnectortrigger.class.php
 * 	\ingroup	stackbuilderconnector
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modStackbuilderconnector_Mytrigger.class.php
 ...
 * Trigger class
 */
class InterfaceStackBuilderConnectortrigger
{
